...
def CarregaRNA_Testa_Ancora(stats = 'Means_Variances.xls', classificador = 'classifier.json', pesos = 'model_weights.h5'):
##    '''
...
##    loaded_model = load_model('loaded_model.workshop')
##    
##    loaded_model
##  
...
##    #retornando o resultado   
    return [1, 0, 0, 1, 1, 1, 1, 0, 0, 1]
    
print(CarregaRNA_Testa_Ancora('Pi.xlsx')) 
